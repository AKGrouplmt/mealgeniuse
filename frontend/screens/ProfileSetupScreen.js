...
const UserProfileScreen = ({ navigation }) => {
  ...
  const calculateGoals = () => {
    ...
    const calculatedGoals = {
      ...
      protein: Math.round((maintenanceCalories * 0.3) / 4).toString(),
      carbs: Math.round((maintenanceCalories * 0.4) / 4).toString(),
      fat: Math.round((maintenanceCalories * 0.3) / 9).toString(),
      water: '2.5'
    };
        ...
        {activeTab === 'profile' ? (
          ...
          <Card style={styles.card}>
            <Card.Content>
              ...
              >
                ...
                >
                  <Ionicons name="calculator" size={moderateScale(20)} color="#333" />
          ...
          <Card style={styles.card}>
            <Card.Content>
              ...
              <View style={styles.row}>
                <View style={[styles.goalInputGroup, { flex: 1, marginRight: spacing.xs }]}>
                ...
                <View style={[styles.goalInputGroup, { flex: 1, marginLeft: spacing.xs }]}>
